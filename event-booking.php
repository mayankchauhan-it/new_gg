            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <form class="form-style4 mb-50" action="./php_files/booking_crud.php" method="POST">
                        ...
                        <!-- Hidden Field For storing other required things in our database -->
                        <input type='hidden'  name="booking_type" value="event"> 
                        <input type='hidden'  name="event_id" value="<?php echo $event['id']; ?>">
                        <input type='hidden'  name="total_price" id="hiddenTotal" value="<?php echo $event['price']; ?>">
                        <input type='hidden'  name="quantity" id="qt" class="form-control" type="number" placeholder="Ticket Quantity">
