    ...
    <main class="main" id="top">
        ...
        <div class="content">
            ...
            <div class="row mb-4 mb-xl-6 mb-xxl-4 gy-3 justify-content-between">
                <div class="col-auto">
                    <h2 class="mb-0 text-body-emphasis">Event List</h2>
                </div>
            </div>
            ...
            <div id="tableExample3"
                ...
                <div id="tableExample3"
                    data-list="{&quot;valueNames&quot;:[&quot;event_id&quot;,&quot;event_name&quot;,&quot;event_description&quot;,&quot;event_date&quot;,&quot;event_time&quot;,&quot;venue&quot;,&quot;price&quot;],&quot;page&quot;:5,&quot;pagination&quot;:true}">

                    <div class="table-responsive">
                        <table class="table table-striped table-sm fs-9 mb-0">
                            <thead>
                                <tr>
                                    <th class="sort border-top border-translucent ps-3" data-sort="event_id">Event ID
                                    </th>
                                    <th class="sort border-top" data-sort="event_name">Event Name</th>
                                    <th class="sort border-top" data-sort="event_description">Description</th>
                                    <th class="sort border-top" data-sort="event_date">Event Date</th>
                                    <th class="sort border-top" data-sort="event_time">Event Time</th>
                            ...
                            <tbody class="list">
                                <?php foreach ($eventData as $event): ?>
                                    <tr>
                                        <td class="align-middle ps-3 event_id"><?php echo $event['event_id']; ?></td>
                                        <td class="align-middle ps-3 event_name"><?php echo $event['event_name']; ?></td>
                                        <td class="align-middle ps-3 event_description">
                                            <?php echo $event['event_description']; ?>
                                        </td>
                                        <td class="align-middle event_date"><?php echo $event['event_date']; ?></td>
                                        <td class="align-middle event_time"><?php echo $event['event_time']; ?></td>
                                        <td class="align-middle venue"><?php echo $event['venue']; ?></td>
                                        <td class="align-middle price"><?php echo $event['price']; ?></td>
                                        <td class="align-middle white-space-nowrap text-end pe-0">
                                            <div class="btn-reveal-trigger position-static">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end py-2">
                                                    <a class="dropdown-item text-danger" href="../php_files/event_crud.php?delete_event=<?php echo $event['event_id'] ?>">Remove</a>
                                                </div>
                                                </div>
                                                </td>
                                                </tr>
