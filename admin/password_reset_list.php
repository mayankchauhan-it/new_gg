    ...
    <main class="main" id="top">
        ...
        <div class="content">
            ...
            <div class="row mb-4 mb-xl-6 mb-xxl-4 gy-3 justify-content-between">
                <div class="col-auto">
                    <h2 class="mb-0 text-body-emphasis">Password Reset Tokens</h2>
                </div>
            </div>

            <!-- Change the data-sort name based on field names -->
                    ...
                    <table class="table table-striped table-sm fs-9 mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="sort border-top" data-sort="token">Token</th>
                                <th class="sort border-top" data-sort="expired">Expires At</th>
                        ...
                        <tbody class="list">
                            <tr>
                                ...
                                <td class="align-middle email w-25">anna@example.com</td>
                                <td class="align-middle token w-25">6578</td>
                                <td class="align-middle expired">25-09-2024</td>
