    ...
    <main class="main" id="top">
        ...
        <div class="content">
            ...
            <div class="row mb-4 mb-xl-6 mb-xxl-4 gy-3 justify-content-between">
                <div class="col-auto">
                    <h2 class="mb-0 text-body-emphasis">Event Add</h2>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="card mb-3">
                        <div class="card-header bg-primary">
                            <h5 class="text-white">Event Details</h5>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="../php_files/event_crud.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control datetimepicker" id="datepicker" name="event_date"
                                        type="text" placeholder="dd/mm/yyyy" required />
                                </div>

                                <div class="form-group">
                                    <label class="form-label" for="event_time">Event Time</label>
                                    <input class="form-control datetimepicker" name="event_time" id="timepicker1"
                                ...
                                <div class="form-group">
                                    <label class="form-label" for="image">Upload Event Image</label>
                                    <input type="file" class="form-control" id="image" name="image" accept="image/*"
                                        required>
                                </div>

                                <button type="submit" name="create_event"
                                    class="btn btn-primary my-3 btn-block font-weight-bold">Create Event</button>
                            </form>
